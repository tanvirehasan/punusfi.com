    ...
    <div class="uk-section" style="background-image: url(img/in-liquid-3-bg.png);" data-uk-img>
        <div class="uk-container">
            <div class="row" data-uk-grid>
                <div class="col-md-6">
                     <img src="img/dollargold.jpg" class="mt-5 pt-3" alt="sample-images" width="100%">
                </div>
                <div class="col-md-6">
                    ...
                    <p>
                        ...
                        to provide traders from all levels of experience with the tools,
                        resources, and support they need to succeed in the exciting and
                        fast-paced world of forex trading. Whether you're just starting
                        out or are a seasoned pro, we offer a range of services designed
                        to meet your needs and help you achieve your financial goals.
                    </p>
                </div>
            </div>
        </div>
