            ...
            <form action="" method="POST">
                <table class="" style="border:none;">
                    ...
                    <tr>
                        ...
                        <td><input type="email" name="email_id" class="form-control  fs-3 p-0 m-0 mt-2" value="<?= UserData('email_id') ?>"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="phone_no" class="form-control fs-3 px-2 p-0 m-0 mt-2" value="<?= UserData('phone_no') ?>"></td>
                    </tr>
