			...
			<div class="menu">
				...
				<div class="menu-item dropdown dropdown-mobile-full">
					...
					<div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
						...
						<a class="dropdown-item d-flex align-items-center" href="profile.php"> <span class="text-white fs-3"><?= UserData('user_name') ?></span> <i class="bi bi-person-circle ms-auto text-theme fs-16px my-n1"></i></a>
						...
						<a class="dropdown-item d-flex align-items-center" href="settings.php"><span class="text-white fs-5">SETTINGS</span> <i class="bi bi-gear ms-auto text-theme fs-16px my-n1"></i></a>

						<div class="dropdown-divider"></div>
						<a class="dropdown-item d-flex align-items-center" href="logout.php"><span class="text-white fs-5">LOGOUT</span> <i class="bi bi-toggle-off ms-auto text-theme fs-16px my-n1"></i></a>
					</div>
				</div>
			</div>
