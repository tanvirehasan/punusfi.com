...
<div id="content" class="app-content">
  ...
  <div class="row text-center">
    <div class="col-12 text-center py-5">
      <img class='p-1' src='assets/img/businessman.png' width='2"+"%'>
      <p class="h3"><a class="nav-link" href="team.php?tree=<?= $leader ?>"><?= $leader ?></a></p>
    </div>
    <!-- Team A  -->
    <div class="col-4  ">
      <?= ($A != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
      ...
      <div class="row py-5">
        ...
        <div class="col-4 ">
          <?php
          $AA = Team_Tree('A', $A);
          echo ($AA != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
        ...
        <div class="col-4 ">
          <?php
          $AB = Team_Tree('B', $A);
          echo ($AB != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
        ...
        <div class="col-4 border-end">
          <?php
          $AC = Team_Tree('C', $A);
          echo ($AC != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
    ...
    <!--======== Team B =========================== -->
    <div class="col-4  ">
      <?= ($B != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
      ...
      <div class="row pt-5 ">
        ...
        <div class="col-4 ">
          <?php
          $BA = Team_Tree('A', $B);
          echo ($BA != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
        ...
        <div class="col-4 ">
          <?php
          $BB = Team_Tree('B', $B);
          echo ($BB != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
          <p class="h5"><?= $BB ?></p>
          <div class="row py-5">
    ...
    <!--============ Team C ================= -->
    <div class="col-4  ">
      <?= ($C != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
      ...
      <div class="row pt-5">
        ...
        <div class="col-4 ">
          <?php
          $CA = Team_Tree('A', $C);
          echo ($CA != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
          <p class="h5"><?= $CA ?></p>
          <div class="row py-5">
        ...
        <div class="col-4 ">
          <?php
          $CB = Team_Tree('B', $C);
          echo ($CB != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
          <p class="h5"><?= $CB ?></p>
          <div class="row py-5">
        ...
        <div class="col-4 ">
          <?php
          $CC = Team_Tree('C', $C);
          echo ($CC != "+") ? "<img class='p-1' src='assets/img/businessman.png' width='5"+"%'>" : "<img class='p-1' src='assets/img/add-user.png' width='1"+""+"%'>";  ?>
          <p class="h5"><?= $CC ?></p>
          <div class="row py-5">
