...
<!-- Mirrored from cryptooapp.netlify.app/temp/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Dec 2022 20:04:39 GMT -->
					...
					<ul class="main-menu">
						...
						<li class="active">
							...
							<ul>
								...
								<li class="active"><a href="forgot-password.html" data-loader="show">Forgot Password</a></li>
							</ul>
						</li>
		...
		<div class="wrapper-inline">
			...
			<main>
				...
				<div class="container">
					...
					<div class="form-row">
						<a href="#" class="button circle block orange">Send me password</a>
					</div>
