...
?>
			...
			<main class="margin mt-0">
				...
				<section class="trans-sec container">
					...
					<ul class="transaction-list list-unstyled mb-0">
						...
						<li>
							<div class="d-flex align-items-center justify-content-between">
	                          <div class="d-flex align-items-center">
	                            <img class="img-xs" src="img/content/coin3.png" alt="coin image">
	                            <div class="ml-10">
						...
						<li class="mb-0">
							<div class="d-flex align-items-center justify-content-between">
	                          <div class="d-flex align-items-center">
	                            <img class="img-xs" src="img/content/coin4.png" alt="coin image">
	                            <div class="ml-10">
				...
				<section class="container">
			         <div class="content"> 
			         	<h4 class="title-main mt-10">Balance Statistics</h4>
					    <div class="c-panel pl-0 pt-10 pb-15">
					...
					<div class="resources-card-wrapper">
						<div class="resources-card mr-10">
	                        <div class="d-flex flex-column flex-md-row">
	                          <img src="img/content/ex2.png" class="max-w mb-10" alt="">
	                    ...
	                    <div class="resources-card ml-10">
	                        <div class="d-flex flex-column flex-md-row">
	                          <img src="img/content/ex1.png" class="max-w mb-10" alt="">
	                          <div class="d-flex flex-column ml-md-2">
