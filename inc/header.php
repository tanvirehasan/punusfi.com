                ...
                <div class="uk-container" data-uk-navbar>
                    ...
                    <div class="uk-navbar-right">
                        <div class="uk-navbar-item uk-visible@m in-optional-nav">
                            <a href="app/singup.php" class="uk-button uk-button-primary uk-border-rounded text-white me-3">Sign up</a>
                            <a href="app/login.php" class="uk-button uk-button-primary uk-border-rounded text-white">Login</a>
                        </div>
                    </div>
                </div>
            </nav>
